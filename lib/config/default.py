...
_C.LOSS = CN()
_C.LOSS.CE_LOSS_COEF = 1.0
_C.LOSS.KPT_LOSS_COEF = 5.0
_C.LOSS.MOCE_STAB_LOSS_COEF = 5.0
_C.LOSS.ANNEAL_CONFIG = CN()
# MoCE Load Balancing Loss Annealing Config
_C.LOSS.ANNEAL_CONFIG.MOCE_LOAD_LOSS = CN()
_C.LOSS.ANNEAL_CONFIG.MOCE_LOAD_LOSS.START_WEIGHT = 0.2
_C.LOSS.ANNEAL_CONFIG.MOCE_LOAD_LOSS.END_WEIGHT = 0.01
_C.LOSS.ANNEAL_CONFIG.MOCE_LOAD_LOSS.ANNEAL_EPOCHS_RATIO = 0.5

_C.LOSS.GUMBEL_TAU_ANNEAL = CN()
_C.LOSS.GUMBEL_TAU_ANNEAL.ENABLED=True
_C.LOSS.GUMBEL_TAU_ANNEAL.START_TAU=2.0
_C.LOSS.GUMBEL_TAU_ANNEAL.END_TAU=0.5
_C.LOSS.GUMBEL_TAU_ANNEAL.ANNEAL_EPOCHS_RATIO=0.8
